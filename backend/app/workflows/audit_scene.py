...
单 activity 任务：调 audit_scene 把最新 draft 送进 ModelGateway，把发现的
问题落到 continuity_issues 表。Sprint 5-A。
"""
...
with workflow.unsafe.imports_passed_through():
    from app.workflows.activities import audit_scene, mark_job_status

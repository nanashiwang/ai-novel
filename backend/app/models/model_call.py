...
class ModelCall(Base, TenantMixin, TimestampMixin):
    ...
    project_id: Mapped[Optional[str]] = mapped_column(String(64), ForeignKey("projects.id"), index=True)
    job_id: Mapped[Optional[str]] = mapped_column(String(64), ForeignKey("generation_jobs.id"), index=True)

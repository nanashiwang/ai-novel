...
main_characters 至少 2 个；每个人物必须尽量补齐 name、role、description、personality、motivation、secret、arc、relationships、current_state。不要只给名字或空描述；secret 是后续反转/冲突可用的隐藏信息。

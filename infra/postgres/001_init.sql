...
CREATE INDEX IF NOT EXISTS idx_revision_sessions_project ON revision_sessions(project_id);
...
CREATE INDEX IF NOT EXISTS idx_revision_messages_session ON revision_messages(session_id);
CREATE INDEX IF NOT EXISTS idx_revision_messages_project ON revision_messages(project_id);
...
CREATE INDEX IF NOT EXISTS idx_revision_proposals_session ON revision_proposals(session_id);
CREATE INDEX IF NOT EXISTS idx_revision_proposals_project ON revision_proposals(project_id);
CREATE INDEX IF NOT EXISTS idx_revision_proposals_target ON revision_proposals(target_type, target_id);
...
CREATE INDEX IF NOT EXISTS idx_revision_applied_changes_proposal ON revision_applied_changes(proposal_id);
CREATE INDEX IF NOT EXISTS idx_revision_applied_changes_project ON revision_applied_changes(project_id);
